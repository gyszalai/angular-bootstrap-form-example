...
function $ControllerProvider() {
  ...
  this.$get = ['$injector', '$window', function($injector, $window) {
     ...
     *
     * @description
     * `$controller` service is responsible for instantiating providers.
     *
...
function $RootScopeProvider(){
  ...
  this.$get = ['$injector', '$exceptionHandler', '$parse', '$browser',
    ...
    Scope.prototype = {
       ...
       * {@link ng.directive:ngController providers} or in
 ...
 *
 * Note that an alternative way to define providers is via the {@link ngRoute.$route $route} service.
 *
 * @element ANY
 * @scope
...
var ngTranscludeDirective = ngDirective({
  controller: ['$transclude', function($transclude) {
    ...
    // that applies only to compile fns and not providers
